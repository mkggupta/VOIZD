...
public class SearchServiceImpl extends AbstractDBManager implements SearchService{
	...
	public List<ElasticSearchServer> getAllLuceneSearchServers() throws DataAccessFailedException {
		try {
			return sqlMapClient_.queryForList(SearchConstants.GET_SEARCH_SERVER_INFO);
