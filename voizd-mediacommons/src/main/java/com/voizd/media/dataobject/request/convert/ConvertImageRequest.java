 ...
 * Time: 3:36 PM
 */
public class ConvertImageRequest extends ConvertMediaRequest {
    public ConvertImageRequest(String fileId, MimeType mimeType, String dimensions) throws UnsupportedTypeException {
    ...
    public ConvertImageRequest(String fileId, MimeType mimeType, Integer width, Integer height) throws UnsupportedTypeException {
        this(fileId, mimeType);
        addMediaAttributes(width, height);
    }

    public ConvertImageRequest(String fileId, MimeType mimeType) throws UnsupportedTypeException {
        super(fileId, mimeType);
    }

    public void addMediaAttributes(Integer width, Integer height) {
