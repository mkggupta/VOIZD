 ...
 * Time: 12:34 PM
 */
public class CreateGetThumbMediaRequest extends BaseMediaRequest {
    protected String fileId_;
    protected MimeType mimeType_;

    public CreateGetThumbMediaRequest(String fileId, MimeType mimeType) throws UnsupportedTypeException {
        super(MediaOperation.CREATETHUMBGET, MediaType.IMAGE, fileId);
        fileId_ = fileId;
        mimeType_ = mimeType;
    }

    public CreateGetThumbMediaRequest(String fileId, MimeType mimeType, Integer width, Integer height) throws UnsupportedTypeException {
        this(fileId, mimeType);
        addMediaAttributes(width, height);
    }

    public CreateGetThumbMediaRequest(String fileId, MimeType mimeType, String dimensions) throws UnsupportedTypeException {
        this(fileId, mimeType);
