 ...
 * Time: 3:53 PM
 */
public class ConvertVideoRequest extends ConvertMediaRequest {
    public ConvertVideoRequest(String fileId, MimeType mimeType, Integer bitRate, String codec) throws UnsupportedTypeException {
        this(fileId, mimeType);
        addMediaAttributes(RequestParam.BITRATE, bitRate);
        addMediaAttributes(RequestParam.CODEC, codec);
    }

    public ConvertVideoRequest(String fileId, MimeType mimeType) throws UnsupportedTypeException {
