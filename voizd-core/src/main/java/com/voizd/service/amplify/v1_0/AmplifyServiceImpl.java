...
import com.voizd.service.amplify.manager.AmplifyManager;

public class AmplifyServiceImpl implements AmplifyService {

	private AmplifyManager amplifyManager;
	
	public void setAmplifyManager(AmplifyManager amplifyManager) {
	...
	public void ampifyContent(Long contentId, Long creatorId, Byte status,Long userId)throws AmplifyServiceFailedException{
		amplifyManager.ampifyContent(contentId,creatorId,status,userId);
	}
	...
	public HashMap<String, Object> getAmplifierList(Long contentId,Long userId,int startLimit,int endLimit, boolean order,Map<String, Object> clientMap) throws AmplifyServiceFailedException  {
		...
		return amplifyManager.getAmplifierList(contentId, userId, startLimit, endLimit, order, clientMap);
	}
